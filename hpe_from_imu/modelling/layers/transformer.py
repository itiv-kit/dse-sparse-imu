# Based on https://github.com/zczcwh/PoseFormer/blob/main/common/model_poseformer.py
# The PoseFormer model was revised from https://github.com/rwightman/pytorch-image-models/blob/master/timm/models/vision_transformer.py
...
class PoseWrapper(nn.Module):
    def __init__(self, num_frames=30):
        ...
        self._pose_transformer = PoseTransformer(
            num_frame=num_frames, num_joints=6, in_chans=12)

    def forward(self, x):
        return self._pose_transformer(x)
